...
#     # Create empty row with all training features
#     df = pd.DataFrame(columns=FEATURE_COLUMNS)

#     # Insert user data into matching columns
...
Placement Prediction Inference Engine
-------------------------------------
Loads trained ML model and predicts placement outcome
for a new student profile.

This script is the production inference pipeline.
"""
